...
__decorate([
    (0, common_1.Post)(),
    (0, permission_decorators_1.Permissions)(permissions_map_1.PERMISSION_MAP['books.create']),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_decorators_1.Permissions)(permissions_map_1.PERMISSION_MAP['books.read']),
    (0, swagger_1.ApiOperation)({ summary: 'Get all books (with users)' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], BooksController.prototype, "getQRCode", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, permission_decorators_1.Permissions)(permissions_map_1.PERMISSION_MAP['books.read']),
    (0, swagger_1.ApiOperation)({ summary: 'Get a book by ID (with users)' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, permission_decorators_1.Permissions)(permissions_map_1.PERMISSION_MAP['books.update']),
...
__decorate([
    ...
    (0, permission_decorators_1.Permissions)(permissions_map_1.PERMISSION_MAP['books.delete']),

...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Manager', description: 'Updated role name' }),
    __metadata("design:type", String)
], UpdateRoleDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: false, description: 'Set role as active/inactive' }),
